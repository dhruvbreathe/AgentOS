...
1. Run `python /Users/celainc/Developers/ClaudeAgentSDK/discord-relay/scripts/maintain_memory.py <my-name> --archive-days 14 --summary-days 7` and read its output.
