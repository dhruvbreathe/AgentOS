...
description: Build and populate 3-statement financial projections (Income Statement, Balance Sheet, Cash Flow Statement) — typically for fundraise decks, board reviews, or scenario planning. Use when asked to build a financial model, populate a model template, complete an IS/BS/CF framework, project revenue/costs/cash forward, or link integrated financial statements. Subscription / cohort businesses included. Triggers: "build a financial projection", "project our financials", "1/2/3-year model", "fundraise financials", "fill in this model template".
---

# 3-Statement Financial Projection
