...
- **Strategic context** — Do they need bull/base/bear scenarios and signposts? That's Step 9 below; skip it if this is a straightforward market map or competitor profile rather than a directional thesis.
...
**For directional / thesis contexts** (skip if the Phase 1 scoping said no):
